...
> [!NOTE]
> This applies to Royal Server 5.04.50925 and newer. In previous versions, Dynamic Folder and Dynamic Credential scripts were executed with the Windows service account of the Royal Server service (by default `LOCAL SYSTEM`).
