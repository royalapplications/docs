...
### -LockdownPolicy
The lockdown policy flags to apply to the document.
...
### -NewLockdownPassword
The new lockdown password to set for the document.
...
### -OldLockdownPassword
The current lockdown password required when the document already has one.
