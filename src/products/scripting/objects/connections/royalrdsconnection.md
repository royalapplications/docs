...
### EnableRdsAadAuth
Type: `bool`, Default Value: `false`  
Determines whether the client will use Microsoft Entra ID to authenticate to the remote PC. Use the Microsoft Entra user principal name (UPN), such as user@domain.com, as the username. In Azure Virtual Desktop, this provides a single sign-on experience.  
### ExecutionMode
...
### KdcProxyUrl
Type: `string`, Default Value: `Empty String`  
The KDC proxy URL used for Kerberos over HTTPS.  
### KeepAliveInterval
Type: `int`, Default Value: `0`  
...
### RedirectWebAuthn
Type: `bool`, Default Value: `false`  
If set to true, WebAuthn requests are redirected.  
## Connect Task
...
### UseExternalProcess
Type: `bool`, Default Value: `false`  
If set to true, mstsc.exe or mstscex.exe is used for external window modes.  
### ExternalProcessSelectedScreens
Type: `string`, Default Value: `Empty String`  
A comma separated list of Royal TS screen indices used for external process fullscreen sessions. An empty value targets all screens.  
### ExternalScreen
Type: `int`, Default Value: `0`  
