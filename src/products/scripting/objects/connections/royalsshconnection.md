...
Type: `string`, Default Value: `Empty String`  
The initial working directory in case of custom terminal connection type (for Windows).  
### Port
...
Environment variable overrides for custom terminal connections on Windows.  
### DECOriginMode
Type: `bool`, Default Value: `false`  
...
### InjectTerminalFileBrowserDirectoryHook
Type: `bool`, Default Value: `false`  
If set to true, Royal TS injects the terminal file browser directory hook for supported terminal sessions.  
### IPVersion
Type: `int`, Default Value: `1`  
IPVersion:   
 0 = Auto   
...
Type: `string`, Default Value: `#2B6CB0`  
The selection background color value.  
### ColorSelectionForeground
Type: `string`, Default Value: `#FFFFFF`  
The selection foreground color value.  
...
### CtrlWheelZoom
Type: `bool`, Default Value: `true`  
Allows changing font size with Ctrl + mouse wheel.  
### Ligatures
Type: `bool`, Default Value: `false`  
...
### PreferKnownHostKeys
Type: `bool`, Default Value: `true`  
Prefer known host keys when negotiating host key algorithms.  
...
### SSHHostKeyExchangeAlgorithmSelectionPolicy
Type: `string`, Default Value: `ed448,ed25519,ecdsa,rsa,dsa,WARN`  
...
### SSHManualHostKeys
Type: `string`, Default Value: `Empty String`  
Manual host keys for PuTTY host key negotiation.  
