...
### AdditionalArguments
Type: `string`, Default Value: `Empty String`  
Additional arguments to pass to the vnc viewer application. Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### ColorDepth
Type: `int`, Default Value: `24`  
8 = 8bpp (256 colors)   
 16 = 16bpp (High color)   
 24 = 24bpp (True color) Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### Compression
Type: `int`, Default Value: `-1`  
The compression level for zip/tight encodings:   
 -1 = off   
 0 = fast   
 9 = best Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### CopyRect
Type: `bool`, Default Value: `true`  
If set to true, copy rect encoding is used. Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### DeiconifyOnBell
Type: `bool`, Default Value: `false`  
If set to true, the VNC connection window will be de-iconified on remote bell event (only works in external mode). Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### DisableClipboardTransfer
Type: `bool`, Default Value: `false`  
If set to true, clipboard transfer is disabled.  
### EightBitMode
Type: `bool`, Default Value: `false`  
If set to true, the number of colors is limited to 256. Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### Encoding
Type: `string`, Default Value: `Empty String`  
The encoding algorithm used for the VNC connection. Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### ExecutionMode
Type: `int`, Default Value: `1`  
0 = In-Process   
 1 = Worker  
...
0 = Low (Fast)   
 1 = Medium   
 2 = High (Slow) Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### HideToolbar
Type: `bool`, Default Value: `false`  
If set to true, the toolbar in the viewer will be hidden (if supported). Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### JpegQuality
Type: `int`, Default Value: `-1`  
...
### NoStatus
Type: `bool`, Default Value: `true`  
If set to true (default), the /nostatus argument is passed to the UltraVNC viewer. Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### Scale
Type: `int`, Default Value: `-1`  
...
### ScaleOSX
Type: `bool`, Default Value: `true`  
Display scaling (on macOS). Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### ScalingMode
Type: `int`, Default Value: `0`  
0 = Fast   
 1 = High Quality  
...
The quality level when displaying remote screens:   
 ...
 1 = Show the screen at full quality (more detailed) Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### SharedConnection
Type: `bool`, Default Value: `false`  
If set to true, the VNC connection is a shared connection  
### SSHTunnelEnabled
Type: `bool`, Default Value: `false`  
If set to true, an SSH tunnel is established for the connection. Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### SSHTunnelHost
Type: `string`, Default Value: `Empty String`  
The host name used to establish the ssh tunnel. Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### TightSecurity
Type: `bool`, Default Value: `true`  
If set to true, Tight security is enabled Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
### TightVncEngine
Type: `int`, Default Value: `0`  
0 = GlavSoft TightVNC   
 1 = GlavSoft Legacy Deprecated: This property belongs to older VNC plugin implementations and may only work with documents or clients that still use those plugins. Royal TS V26 uses the RoyalVNC plugin.  
## Credentials
### CredentialAutologon
Type: `bool`, Default Value: `true`  
...
### ProxmoxIgnoreCertificateErrors
Type: `bool`, Default Value: `true`  
Ignore TLS certificate validation errors on the Proxmox console websocket. Proxmox defaults to a self-signed certificate.  
### ProxmoxNode
Type: `string`, Default Value: `Empty String`  
Proxmox cluster node name hosting the VM/container. Used together with ProxmoxVMID and ProxmoxVmType when this VNC connection is a Proxmox console: on every connect a fresh console ticket is requested and the session is relayed through a local bridge. URI holds the Proxmox host.  
### ProxmoxUseHttps
Type: `bool`, Default Value: `true`  
Use HTTPS (wss) for the Proxmox console websocket in console mode.  
### ProxmoxVMID
Type: `string`, Default Value: `Empty String`  
Numeric Proxmox VMID. When set, this VNC connection is a Proxmox console: each connect issues a one-time vncproxy ticket (via the assigned Royal Server management endpoint and stored credential) instead of using Port/CredentialPassword directly.  
### ProxmoxVmType
Type: `string`, Default Value: `qemu`  
Proxmox guest type for console mode: 'qemu' for virtual machines, 'lxc' for containers (an LXC console is the container terminal rendered over VNC).  
## Connect Task
