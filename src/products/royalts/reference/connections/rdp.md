...
The **Remote Desktop** connection _(based on Microsoft RDP)_ can be used to connect to remote computers or Hyper-V guests using the remote desktop protocol (RDP). Royal TS V26 uses the built-in Microsoft RDP client components.
...
## ![](/r2023/images/RoyalTS/Plugins/Connections/RemoteDesktop/SVG_PagePerformance_32.svg#img_header) Performance
