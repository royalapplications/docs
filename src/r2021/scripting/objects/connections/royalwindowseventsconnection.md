---
uid: scripting_object_royalwindowseventsconnection
name: RoyalWindowsEventsConnection
order: 8200
---
...
Limits the number rows in the grid.  
### ShowDetailsPanel
...
### FilterID1
Type: `int`, Default Value: `0`  
Either the event ID for equals mode or the first event ID for between mode.  
### FilterID2
Type: `int`, Default Value: `0`  
The event ID 2 for the between filter ID mode.  
### FilterIDMode
Type: `int`, Default Value: `0`  
0 = All   
 1 = Equeals   
...
The event log filter string. If emtpy or 'All', no filter is applied.  
### FilterTimeRangeMode
Type: `int`, Default Value: `0`  
0 = Relative   
 1 = Specific   
 2 = None  
### FilterTimeRangeRelativeUnit
Type: `int`, Default Value: `1`  
The time range unit: 0 = Minutes   
 1 = Hours   
 2 = Days   
### FilterTimeRangeRelativeValue
Type: `int`, Default Value: `2`  
The time range value.  
### FilterTimeRangeSpecificDateTimeFrom
Type: `DateTime`, Default Value: `DateTime.Now`  
The from date and time for specific time range.  
### FilterTimeRangeSpecificDateTimeFromEnabled
Type: `bool`, Default Value: `false`  
If set to true, the from time range is enabled.  
### FilterTimeRangeSpecificDateTimeTo
Type: `DateTime`, Default Value: `DateTime.Now`  
The to date and time for specific time range.  
### FilterTimeRangeSpecificDateTimeToEnabled
Type: `bool`, Default Value: `false`  
If set to true, the to time range is enabled.  
## Key Sequence
### KeySequence
Type: `string`, Default Value: `Empty String`  
