---
uid: scripting_object_royalvmwareconnection
name: RoyalVMwareConnection
order: 7700
---
...
Use HTTPS  
### ServicePort
Type: `int`, Default Value: `443`  
The service port is used for service connections to the VMware host.  
