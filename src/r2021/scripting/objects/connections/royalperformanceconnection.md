---
uid: scripting_object_royalperformanceconnection
name: RoyalPerformanceConnection
order: 8400
---
...
The number of samples for this connection. Max. value is 65535.  
### PollingTimeoutStrategy
Type: `int`, Default Value: `0`  
Controls the number of threads used for polling:   
 0 = Automatic   
 1 = Per Server   
 2 = Per Counter  
### SampleAutomatically
Type: `bool`, Default Value: `true`  
If set to true, sampling will be started automatically after the connection was established.  
### ShowChartLegend
Type: `bool`, Default Value: `false`  
If set to true, the legend is shown in the connection.  
### ShowCounterList
Type: `bool`, Default Value: `true`  
If set to true, the list of configured counters is shown in the connection.  
### UpdateInterval
...
Appearance name for the chart.  
### ChartBackground1
Type: `string`, Default Value: `#FFFFFF`  
Chart background color 1.  
### ChartBackground2
Type: `string`, Default Value: `#F5F5F5`  
Chart background color 2.  
### TimeBarColor
Type: `string`, Default Value: `#FF9999`  
...
## Display Options
### AutomaticVerticalScale
Type: `bool`, Default Value: `true`  
If set to true, the vertical axis is scaled automatically.  
### ChartTitle
Type: `string`, Default Value: `Empty String`  
The caption of the chart.  
### DataCollectionMode
Type: `int`, Default Value: `0`  
Controls the way Royal TS shows the collected data:   
 0 = Wrap   
 1 = Scroll  
### MaxVerticalScale
...
### ShowHorizontalGrid
Type: `bool`, Default Value: `true`  
If set to true, a horizontal grid is shown in the chart.  
### ShowTimeAxisLabels
Type: `bool`, Default Value: `true`  
If set to true, the time axis labels are shown in the chart.  
### ShowVerticalGrid
Type: `bool`, Default Value: `false`  
If set to true, a vertical grid is shown in the chart.  
### ShowVerticalScaleNumbers
Type: `bool`, Default Value: `true`  
If set to true, vertical scale numbers are shown in the chart.  
### VerticalAxis
Type: `string`, Default Value: `Empty String`  
The vertical axis caption of the chart.  
## Key Sequence
### KeySequence
Type: `string`, Default Value: `Empty String`  
...
### DashboardShowChartLegend
Type: `bool`, Default Value: `false`  
If set to true, the legend is shown in the dashboard.  
### DashboardSampleAutomatically
Type: `bool`, Default Value: `false`  
If set to true, sampling will be started automatically in the dashboard.  
## Royal Server
