---
uid: scripting_object_royalwindowsprocessesconnection
name: RoyalWindowsProcessesConnection
order: 8100
---
...
### GetOwner
Type: `bool`, Default Value: `false`  
If set to true, the process owner for each process is retrieved (might impact performance).  
## Filter
