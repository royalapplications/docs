---
uid: scripting_object_royaldynamicfolder
name: RoyalDynamicFolder
order: 9700
---
...
Type: `string`, Default Value: `json`  
The interpreter for executing the dynamic credential script.  
### DynamicCredentialScriptContent
Type: `string`, Default Value: `Empty String`  
The script to execute for getting information about a dynamic credential.  
## Advanced
### AutoReloadContents
Type: `bool`, Default Value: `false`  
Whether or not the folder's contents is reloaded automatically when the document is opened.  
### PersistContents
Type: `bool`, Default Value: `false`  
